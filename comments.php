...
<section id="comments" class="mt-20 pt-10 border-t border-gray-100 dark:border-gray-800 max-w-zen mx-auto">
    ...
    <div class="mb-8">
        ...
        $args = array(
            ...
            'logged_in_as' => '<p class="text-xs text-gray-600 mb-6">已登录为 <a href="' . esc_url(admin_url('profile.php')) . '" class="underline font-medium text-gray-900 dark:text-white">' . esc_html(wp_get_current_user()->display_name) . '</a>。 <a href="' . esc_url(wp_logout_url(get_permalink())) . '" class="text-red-500 hover:underline">注销?</a></p>',
