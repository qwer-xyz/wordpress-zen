...
<footer role="contentinfo" class="w-full border-t border-gray-100 dark:border-gray-800 mt-auto">
    <div class="max-w-zen mx-auto px-4 sm:px-6 py-6 md:h-20 md:py-0 flex flex-col md:flex-row items-center justify-between text-xs text-gray-600 dark:text-gray-400 gap-y-3">
        ...
        <div class="flex items-center gap-4">
            ...
            <a href="https://github.com/qwer-xyz/wordpress-zen" target="_blank" rel="noopener noreferrer" class="hover:text-gray-900 dark:hover:text-white transition-colors" aria-label="Theme By Zen (在新窗口打开)">Theme By Zen</a>
            ...
            <span class="inline-block w-1 h-1 bg-gray-300 rounded-full" aria-hidden="true"></span>
            <a href="<?php echo esc_url(get_bloginfo('rss2_url')); ?>" target="_blank" rel="noopener noreferrer" class="hover:text-gray-900 dark:hover:text-white transition-colors flex items-center gap-1" title="订阅 RSS">
