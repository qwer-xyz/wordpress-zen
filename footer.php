...
<!-- Back to Top -->
<button id="back-to-top" class="zen-icon-btn fixed bottom-8 right-8 w-10 h-10 bg-gray-900 dark:bg-white text-white dark:text-black rounded-full shadow-lg flex items-center justify-center opacity-0 pointer-events-none translate-y-4 z-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900" aria-label="返回顶部">
